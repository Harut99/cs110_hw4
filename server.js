...
const todo = [
	{id: 0, text: 'Stand up', complited: false},
	{id: 1, text: 'Go bathroom', complited: false},
	{id: 2, text: 'Go AUA', complited: false}
];
let todonextitemid = todo.length;

const cbFunc1 = function (req, res) {

	if (req.url === '/') // set default url to /index.html
		req.url = '/index.html';
...
const srv = http.createServer(cbFunc1);
srv.listen(3001);